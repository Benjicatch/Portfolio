...
<template>
  ...
  <div class="about">
    <section>
      ...
      <p class="align-text">
        I am a French citizen 🇫🇷, born in Bordeaux 🍷, and I am 21 years old.<br />
        I am currently in my 4th year at Epitech Nantes, a computer science school 🏫.<br />
        I love learning new things and am always looking for new challenges 🚀.<br />
      </p>
    </section>
    <section>
      <h2 class="title">🚀 Why I Love Tech</h2>
      <p class="align-text">
        For me, programming is like a puzzle, I love solving problems and creating new things 🧩.<br />
        It allows me to build things that can help people, and I love seeing the impact of my work on others 🌍.<br />
        For these reasons, I want to work in the tech industry to create new things and help people in their daily lives 🚀.<br />
      </p>
    </section>
    ...
    <section>
      ...
      <p class="align-text">
        ...
        Sometimes, I enjoy exploring new passions like chess, Blender, or drawing, always experimenting with different things 🎨.<br />
      </p>
    </section>
    ...
    <section>
      ...
      <p class="align-text">
        ...
        I know how to play mahjong 🀄 and am a big fan of the game.<br />
